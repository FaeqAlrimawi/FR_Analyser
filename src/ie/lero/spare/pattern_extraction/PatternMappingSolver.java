...
public class PatternMappingSolver {
	...
	//result containing integer which indicates solution id and list of integers that
	...
	public PatternMappingSolver() {
		...
		mappedPatterns = new LinkedList<int[]>();
...
//			model.setObjective(Model.MAXIMIZE, severitySum);
	...
	protected Map<Integer, List<Integer>> analyseSolutions(List<Solution> solutions, SetVar [] patterns, IntVar severitySum) {
