...
<environment:EnvironmentDiagram xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:environment="http://www.example.org/environment">
  ...
  <asset xsi:type="environment:Desktop" connections="d1_1" name="desktop1_1" control="Desktop" parentAsset="instructorsLab1"/>
  ...
  <asset xsi:type="environment:IPNetwork" connections="d1_1 d1_2 d2_1 d3_1 d4_1 d5_1 d5_2 d6_1 d6_2 d7_1" name="IPnetwork1" control="IPNetwork" Protocol="TCP/IP" encryption="MACsec">
    <type name="Ethernet"/>
  </asset>
  <asset xsi:type="environment:Lab" name="instructorsLab2" control="Lab" containedAssets="desktop2_1 desktop2_2"/>
  <asset xsi:type="environment:Lab" name="instructorsLab3" description="" control="Lab" containedAssets="desktop3_1 desktop3_2"/>
  <asset xsi:type="environment:Lab" name="instructorsLab4" control="Lab" containedAssets="desktop4_1 desktop4_2"/>
  <asset xsi:type="environment:Lab" name="instructorsLab5" control="Lab" containedAssets="desktop5_1 desktop5_2"/>
  <asset xsi:type="environment:Lab" name="instructorsLab6" control="Lab" containedAssets="desktop6_1 desktop6_2"/>
  <asset xsi:type="environment:Lab" name="instructorsLab7" control="Lab" containedAssets="desktop7_1 desktop7_2"/>
  <asset xsi:type="environment:Lab" connections="openLab_hallway1 openLab_hallway2" name="openLab" control="Lab_2"/>
  <asset xsi:type="environment:Lab" connections="empiricalLab_hallway1 empiricalLab_hallway2 empiricalLab_hallway3 empiricalLab_hallway4" name="empiricalLab" control="Lab_4"/>
  <asset xsi:type="environment:Lab" connections="informaticsLab_hallway1 informaticsLab_hallway2 informaticsLab_hallway3 informaticsLab_hallway4" name="informaticsLab" control="Lab_4"/>
  <asset xsi:type="environment:Toilet" connections="mensToilet_hallway" name="mensToilet" control="Toilet"/>
  <asset xsi:type="environment:Toilet" connections="womensToilet_hallway" name="women'sToilet" control="Toilet"/>
  <asset xsi:type="environment:Toilet" connections="disabledToilet_hallway" name="disabledToilet" control="Toilet"/>
  <asset xsi:type="environment:Kitchen" connections="kitchen_hallway kitchen_airConditioningRoom" name="kitchen" control="Kitchen"/>
  <asset xsi:type="environment:Room" connections="kitchen_airConditioningRoom" name="airConditioningRoom" control="Room"/>
  <asset xsi:type="environment:Lab" name="researchLab1" description="" control="Lab"/>
  <asset xsi:type="environment:Lab" name="researchLab2" control="Lab"/>
  <asset xsi:type="environment:Lab" name="visitingLab1" control="Lab"/>
  <asset xsi:type="environment:Lab" name="visitorLab2" control="Lab"/>
  ...
  <connection xsi:type="environment:PhysicalConnection" asset1="hallway" asset2="visitorLab2" name="visitingLab2_hallway"/>
